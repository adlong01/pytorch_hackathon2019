...
class QueryExecutor:
	def __init__(self, search_query):
		...
		self.class_vector_path = "/Applications/AMPPS/www/searchMonkey/python/embeddings/class_vector.pkl"
		self.obj_detect_path = "/Applications/AMPPS/www/searchMonkey/python/processed_video_data/group_results.p"
		self.results_output_path = "/Applications/AMPPS/www/searchMonkey/python/to_frontend/detected_frames.txt"
